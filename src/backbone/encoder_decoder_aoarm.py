...
class LLMasEncoderDecoderAnyOrder(nn.Module):
    def __init__(
        self,
    ...
    def forward(
        ...
        attention_mask_block_context: torch.FloatTensor
        | BlockMask
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        # TODO: Debugging: Copy outer encoder KVs as inner encoder -->
        #  should reduce problem to AR for block size 2
        ...
        for decoder_layer in self.decoder.model.layers:
            ...
            # Cross-attend to encoder kvs and KVs from clean tokens
